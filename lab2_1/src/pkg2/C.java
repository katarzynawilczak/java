...
public class C extends B{
	public C(int n, String na){
		...
		/*void changeName(){
			name="Ela";			//pole o dostepie pakietowym z tego innego pakietu niewidziane w klasie pochodnej
		}*/
	...
	public static void main(String[] argv){
		...
		ob1.callChangeName(); //zmiana imienia metoda kl A
		//ob1.decrement(); //niewidoczna metoda protected w A
		ob1.callDecrement(); //wywo³ana metoda z klasy A
