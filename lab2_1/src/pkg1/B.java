...
public class B extends A{
	...
	void changeName(){
		name="Olaaa "; //pole o dostepie pakietowym z tego samego pakietu widziane w klasie pochodnej
	}
	...
	public static void main(String[] argv){
		...
		ob1.decrement(); //pomniejsza o 3 - nadpisana metoda z B
		ob1.Show();
		...
		A ob2 = new A(3, "Agata ");
		ob2.callIncrement(); // powieksza o 1 metoda z kl A
